...
namespace Bai2._10
{
    public partial class Form1 : Form
    {
        ...
        private void btnChuVi_Click(object sender, EventArgs e)
        {
            ...
            int chuVi = (a + b) * 2;
            MessageBox.Show("Chu vi hinh chu nhat la: " + chuVi);
        }
        ...
        private void btnDienTich_Click(object sender, EventArgs e)
        {
            ThongTin(out int a, out int b);
            int dienTich = a * b;
            MessageBox.Show("Dien tich hinh chu nhat la: " + dienTich);
        }
        ...
        private void btnDuongCheo_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Do dai duong cheo hinh chu nhat la: " + duongCheo);
        }
